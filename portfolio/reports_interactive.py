...
# %% auto #0
__all__ = ['return_drivers_w', 'time_period_w', 'portfolio_info_w', 'portfolio_overview', 'interactive_report']
...
def portfolio_overview(p):
    ...
    return pn.Tabs(('Portfolio Overview', overview), ('Correlation Matrix', corr), ('Return Drivers', return_drivers), ('Info', info))
